There is a picture of our Air Control Station model that we've built in the UE IF3E with laser-cut wood. It contains one ESP32 board and 3 sensors ()  in order to get all properties of a room. 
